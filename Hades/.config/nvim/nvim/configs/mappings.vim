...
nnoremap <silent> <leader>nn :call nerdcommenter#Comment(0,"toggle")<cr>
vnoremap <silent> <leader>nn :call nerdcommenter#Comment(1,"toggle")<cr>
" Toggle a sexy comment
nnoremap <silent> <leader>ns :call nerdcommenter#Comment(0,"sexy")<cr>
vnoremap <silent> <leader>ns :call nerdcommenter#Comment(1,"sexy")<cr>
" append a  comment
nnoremap <silent> <leader>na :call nerdcommenter#Comment(0,"append")<cr>
vnoremap <silent> <leader>na :call nerdcommenter#Comment(1,"append")<cr>
" uncomment section
nnoremap <silent> <leader>nu :call nerdcommenter#Comment(0,"uncomment")<cr>
vnoremap <silent> <leader>nu :call nerdcommenter#Comment(1,"uncomment")<cr>
" invert comments
nnoremap <silent> <leader>ni :call nerdcommenter#Comment(0,"invert")<cr>
vnoremap <silent> <leader>ni :call nerdcommenter#Comment(1,"invert")<cr>
" comment section
nnoremap <silent> <leader>nc :call nerdcommenter#Comment(0,"comment")<cr>
vnoremap <silent> <leader>nc :call nerdcommenter#Comment(1,"comment")<cr>
